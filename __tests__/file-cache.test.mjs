...
describe('FileCache', () => {
  ...
  describe('Pattern-based Clearing', () => {
    ...
    it('should clear entries matching pattern with wildcard', () => {
      ...
      assert.deepStrictEqual(cache.get('list:pubky://user2/pub/'), ['file2.txt']);
      assert.strictEqual(cache.get('file:pubky://user1/pub/file1.txt'), 'content1');
    });
    ...
    it('should clear all list entries', () => {
      ...
      assert.strictEqual(cache.get('file:pubky://user1/pub/file1.txt'), 'content1');
      assert.strictEqual(cache.get('file:pubky://user2/pub/file2.txt'), 'content2');
    });
    ...
    it('should handle exact pattern matching', () => {
      ...
      assert.deepStrictEqual(cache.get('list:pubky://user1/pub/docs/'), ['doc1.md']);
      assert.deepStrictEqual(cache.get('list:pubky://user2/pub/'), ['file2.txt']);
    });
  });
